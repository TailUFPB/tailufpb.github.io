    ...
    <div>
          ...
          <div className="sobre-box">
            <div className="sobre-text">
              <p>
                ...
                organização sem fins lucrativos, dirigida por estudantes. Nossa jornada começou em 2020, durante a pandemia. 
                <br />
      ...
      <div className="distance-separator">
        <div className="distance-block">
          ...
          <p className="text-block">A TAIL é aberta para o público em geral, <br /> de todos os cursos.</p>
        </div>
        <div className="separator" />
        <div className="distance-block">
          <img src={ideaLogo} alt="Idea Logo" className="image-block" />
          <p className="text-block">Nós incentivamos fortemente e <br /> promovemos pesquisa e inovação <br /> em tecnologia.</p>
        </div>
        <div className="separator" />
        <div className="distance-block">
          <img src={wifiLogo} alt="Wifi Logo" className="image-block" />
          <p className="text-block">A inteligência artificial tem aplicação<br /> em uma ampla variedade de áreas do<br /> conhecimento.</p>
        </div>
      </div>
      <section className="distance-white-logo">
        ...
        <div className="sobre-box" style={{ marginTop: '20px', marginBottom: '50px' }}>
          <p className="sobre-text">Temos como objetivo promover um ambiente para troca de conhecimentos em áreas como<br />
          inteligência artificial, ciência de dados, cálculo e estatística, bem como estimular e divulgar<br /> estudos científicos, publicações e cursos.</p>
        </div>
      </section>
      <div className="page-gradient" /> {/* Adiciona o degradê que acompanha o scroll abaixo de todos os elementos */}
    </div>
  );
}
